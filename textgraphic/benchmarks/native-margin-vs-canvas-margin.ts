...
benchmark.measure("100 -> 200 / Native", () => {
  const marginedSample = SAMPLE_BACKGROUND.applyMargin(50, 50, 50, 50);
...
benchmark.measure("100 -> 500 / Native", () => {
  const marginedSample = SAMPLE_BACKGROUND.applyMargin(200, 200, 200, 200);
  marginedSample.styledForm;
});
...
benchmark.measure("100 -> 1000 / Native", () => {
  const marginedSample = SAMPLE_BACKGROUND.applyMargin(450, 450, 450, 450);
  marginedSample.styledForm;
});
...
benchmark.measure("100 -> 2000 / Native", () => {
  const marginedSample = SAMPLE_BACKGROUND.applyMargin(950, 950, 950, 950);
  marginedSample.styledForm;
});
...
benchmark.measure("100 -> 200 / Canvas", () => {
  const canvas = new TextGraphic.CanvasView(200, 200, renderer);
...
benchmark.measure("100 -> 500 / Canvas", () => {
  const canvas = new TextGraphic.CanvasView(500, 500, renderer);
...
benchmark.measure("100 -> 1000 / Canvas", () => {
  const canvas = new TextGraphic.CanvasView(1000, 1000, renderer);
...
benchmark.measure("100 -> 2000 / Canvas", () => {
  const canvas = new TextGraphic.CanvasView(2000, 2000, renderer);
