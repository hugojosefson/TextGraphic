...
const box1 = TextGraphic.ShapeView.initBlankRectangle(8, 3, styler)
...
const box2 = TextGraphic.ShapeView.initBlankRectangle(8, 3, styler)
  .frame(TextGraphic.Presets.LightBox);
box2.style = {
  color: "red",
};

const box3 = TextGraphic.ShapeView.initBlankRectangle(8, 3, styler)
  .frame(TextGraphic.Presets.LightBox);
...
const canvas = new TextGraphic.CanvasView(21, 10, styler);
...
Tools.setCursorToBottomRight(
  "Over-lapping Views and Transparency in TextGraphic ",
);
