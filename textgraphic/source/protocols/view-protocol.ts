 ...
 */
export type ScreenMatrixPixel = [string, string, string];
...
export interface ViewProtocol<
  ...
  EnvironmentStylingSettings extends PortableStyle<any>,
  RenderStyler extends StyleRendererProtocol<
    ColorType,
    EnvironmentStylingSettings
  >,
> {
  //
  ...
  applyMargin(
    ...
    bottomMargin: number,
    leftMargin: number,
  ): ViewProtocol<ColorType, EnvironmentStylingSettings, RenderStyler>;
...
export interface StylableViewProtocol<
  ColorType extends PortableColor,
  EnvironmentStylingSettings extends PortableStyle<any>,
> extends
  ViewProtocol<
    ColorType,
    EnvironmentStylingSettings,
    StyleRendererProtocol<ColorType, EnvironmentStylingSettings>
  > {
  /**
   ...
   */
  addStyle(
    style: Partial<EnvironmentStylingSettings>,
  ): ViewProtocol<
    ColorType,
    EnvironmentStylingSettings,
