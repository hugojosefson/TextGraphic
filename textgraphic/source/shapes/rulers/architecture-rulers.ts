...
export function createVerticalArchitectureRuler<
...
>(
  ...
  //
  const lineChar = chars.line;
  const startChar = chars.start ? chars.start : lineChar;
  const endChar = chars.end ? chars.end : lineChar;
